    ...
    ? [
        {
          ...
          '@type': 'WebSite',
          name: 'ComPear',
          url: `https://compears.shop/${countryCode}`,
          potentialAction: {
            '@type': 'SearchAction',
            target: `https://compears.shop/${countryCode}/search?q={search_term_string}`,
        ...
        },
        {
          ...
          '@type': 'Organization',
          name: 'ComPear',
          url: 'https://compears.shop',
          logo: 'https://compears.shop/logo512.png',
        },
      ]
    : undefined;
